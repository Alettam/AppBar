        ...
        mBtnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mStartDate > mEndDate) {
                    Toast.makeText(CalendarviewActivity.this, "Ошибка ввода дат", Toast.LENGTH_LONG).show();
                    mChooseStartDate.setText("Дата-время старта задачи:");
                    mChooseEndDate.setText("Дата-время окончания задачи:");
                }else {
                    Toast.makeText(CalendarviewActivity.this, "старт: " + mStartDateTxt + "окончание: " + mEndDateTxt, Toast.LENGTH_LONG).show();
                }
            }
        });
